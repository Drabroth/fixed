...
local function DrawIt(modname,configfile,_config,config,OnChange,dontInitHotkey,font)
    ...
    -- Disabled because current DD2/REFramework throws an exception
    -- while enumerating app.ItemManager._ItemDataDict.
    -- AutoLootBody does not need the item selector anyway.
            ...
            for _,para in ipairs (_config) do
                ...
                if para.type=="int" then
        		    changed , config[key]= imgui.drag_int(label .. title_postfix, 
                                                            ...
                                                            para.step or 1 , para.min or 0, para.max or 200)
